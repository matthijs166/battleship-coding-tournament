...
import type { BrainConstructor, brainGameData } from "$game/objects/brain";
import { CellState } from "$game/objects/playboardCell";
...
export default class Game {
    ...
    radarLimits: { player1: number, player2: number };
