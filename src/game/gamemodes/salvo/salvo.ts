...
export default class Salvo {
    ...
    shotsPerTurn: number = 5; // Set shots per turn to 5
    currentShots: number = 0; // Reintroduce this property to track current shots in the turn
    ...
    updateTick(){
        ...
        this.currentShots++;
        if (this.currentShots >= this.shotsPerTurn) {
            // finish the turn
...
export type GameStats = ReturnType<Salvo["getStats"]>;